...
class New_Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, neckplanes_1, neckplanes_2, outplane, stride=1, downsample=None):
        super(New_Bottleneck, self).__init__()
        self.conv1 = nn.Conv2d(inplanes, neckplanes_1, kernel_size=1, bias=False)
        self.bn1 = nn.BatchNorm2d(neckplanes_1)
        self.conv2 = nn.Conv2d(neckplanes_1, neckplanes_2, kernel_size=3, stride=stride,
                               padding=1, bias=False)
        self.bn2 = nn.BatchNorm2d(neckplanes_2)
        self.conv3 = nn.Conv2d(neckplanes_2, outplane, kernel_size=1, bias=False)
